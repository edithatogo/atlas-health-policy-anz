from australian_health_policy_atlas.gold import (
    classify_modality,
    extract_simple_assertion_fields,
)
...
def test_no_modality_and_conflicting_distinct_clauses() -> None:
    ...
    conflict = classify_modality(
        "Nurses must document care and doctors should review it."
    )
